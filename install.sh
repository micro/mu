...
echo ""
echo "  mu --serve"
echo "  # then open http://localhost:8080 — Mu walks you through"
echo "  # creating an admin account and picking an AI provider."
echo ""
echo "  # Prefer the terminal? Configure the provider first:"
echo "  mu setup"
echo ""
