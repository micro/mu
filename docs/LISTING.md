...
At the time of writing that is 118 tools, all titled and annotated, the longest
...
index and the app sandbox, and exposes 118 tools over a single endpoint. Lead
