...
At the time of writing that is 115 tools, all titled and annotated, the longest
...
index and the app sandbox, and exposes 115 tools over a single endpoint. Lead
