...
At the time of writing that is 112 tools, all titled and annotated, the longest
...
index and the app sandbox, and exposes 112 tools over a single endpoint. Lead
