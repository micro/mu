...
At the time of writing that is 117 tools, all titled and annotated, the longest
...
index and the app sandbox, and exposes 117 tools over a single endpoint. Lead
