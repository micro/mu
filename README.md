...
| **Hazards** | `hazards_quakes` — recent earthquakes worldwide from the USGS, with magnitude, place, how long ago and any tsunami warning. Pass a lat/lon to ask about somewhere in particular. Needs no key |
