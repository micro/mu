...
| **SMS** | `sms_send` · `sms_history` · `sms_number` · `sms_verify` — text somebody and read what they text back, from a real number. Only to numbers you already know: a contact, a number you verified as yours, or one that texted you first |
