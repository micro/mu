  ...
  <body%s>
    <div id="head">
      ...
      <div id="account" style="-webkit-tap-highlight-color: transparent;">
        ...
        <a id="voice-header" href="#" style="display: none; -webkit-tap-highlight-color: transparent;" title="Voice: say 'Hey Micro'"><span id="voice-icon">🎤</span><span class="label">Voice</span></a>
