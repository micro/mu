...
func FooterLinks() string {
	return `<a href="/about">About</a> · <a href="/pricing">Pricing</a> · <a href="/agents">Agents</a> · <a href="/docs">Docs</a> · <a href="/status">Status</a> · <a href="https://github.com/micro/mu">Source</a>` + torFooterLink()
}
