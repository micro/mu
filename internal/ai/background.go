...
func checkBackground(caller string) error {
	switch caller {
	case "arrival-gate", "agent.compact", "daily-digest", "moderate", "flagged", "social-judge", "news-sentiment", "notes-generate", "opinion-generate", "article-summary", "auto-tag-post", "auto-tag-note", "topic-summary", "topic-generation":
