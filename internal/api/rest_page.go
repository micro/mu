...
func restAuthCard(base string) string {
	...
	b.WriteString(`<p><b>A token.</b> Make one at <a href="/account/tokens">Tokens</a> and send it ` +
  ...
  `+base+RESTPrefix+`notes/list`) + `</pre>`)
	...
	b.WriteString(`<p><b>Paying instead.</b> A metered method answers an unauthenticated ` +
		...
		`succeeds. No account, no signup — every tool carries its price on <a href="/tools">tools</a>.</p>`)
