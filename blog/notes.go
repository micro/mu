...
- Mu is a personal home server for the everyday internet: you ask it in plain language and it calls real services — news, mail, search, weather, markets, video, blog, places, reminders and apps — and gives a single answer. You run it yourself, and it remembers your preferences over time.
