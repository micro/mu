	...
	if showWriteForm {
		...
		if acc != nil && acc.Admin {
			...
			actions = `<div style="margin-bottom: 15px;">
				<a href="/blog?write=true" style="padding: 10px 15px; background: var(--btn-primary, #000); color: white; text-decoration: none; border-radius: var(--border-radius, 6px); display: inline-block; font-size: 14px;">+ Write a Post</a>
