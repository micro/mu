...
func importHandler(w http.ResponseWriter, r *http.Request) {
	...
	body := fmt.Sprintf(`<div class="card"><p>Imported %d contacts. Skipped %d existing email addresses. %d rows could not be imported.</p><a class="btn" href="/contacts">All contacts</a></div>`, added, skipped, failed)
