...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	b.WriteString(`<div id="shell-terminal-controls" class="form-actions shell-terminal-actions" data-csrf="` + html.EscapeString(auth.CSRFToken(r)) + `"><button type="button" id="shell-connect">Open terminal</button><button type="button" id="shell-disconnect" hidden>Disconnect</button><button type="button" hidden data-terminal-key="ctrl-c" disabled>Ctrl+C</button><button type="button" hidden data-terminal-key="tab" disabled>Tab</button><button type="button" hidden data-terminal-key="escape" disabled>Esc</button><button type="button" hidden data-terminal-key="up" aria-label="Up arrow" disabled>↑</button><button type="button" hidden data-terminal-key="down" aria-label="Down arrow" disabled>↓</button><button type="button" hidden data-terminal-key="left" aria-label="Left arrow" disabled>←</button><button type="button" hidden data-terminal-key="right" aria-label="Right arrow" disabled>→</button><span id="shell-status" role="status">Disconnected</span></div><div id="shell-terminal" class="shell-terminal" aria-label="Terminal" hidden></div><noscript>JavaScript is needed for the terminal. You can also connect using SSH below.</noscript>`)
