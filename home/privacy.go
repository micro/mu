...
func PrivacyHandler(w http.ResponseWriter, r *http.Request) {
	...
	section("Optional Google connections",
		`Signing in with Google does not grant access to your mail or files. Calendar, Contacts, Gmail and Drive require separate, optional read-only consent. You can review your connections and disconnect Google in Account.`,
		`A refresh token is stored to maintain connections. Mail, contacts and files are looked up on demand, not bulk imported. Selected calendars contribute to your agenda and brief. Content used to answer your question is sent to this instance's configured AI provider and may be retained in the conversation. These connections cannot send Gmail messages or change Drive files.`)
	...
	section("Tokens and connected agents",
		`A token, or a client you signed in through the MCP
		 ...
		 data. Revoke either at <a href="/account/clients">Clients</a>. Anything an agent did
