...
func apiTokenForm(r *http.Request, accountID string) string {
	...
	sb.WriteString(app.Field{Name: "client", Label: "Access", Options: []app.Option{{Value: "mail", Label: "Mail", On: kind == "mail"}, {Value: "chat", Label: "Chat (XMPP)", On: kind == "xmpp"}, {Value: "api", Label: "Assistant and account access", On: agentAccess}, {Value: "services", Label: "Services API / MCP", On: serviceAccess}}}.HTML())
